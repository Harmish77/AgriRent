...
<div class="main-content">
    ...
    <div class="report-sections">
        <div class="report-section">
            <h3>Equipment Status Summary</h3>
            <div class="status-list">
                <div>✅ Approved: <strong><?= $approved_equipment; ?></strong></div>
                <div>⏳ Pending: <strong><?= $pending_equipment; ?></strong></div>
                <div>❌ Rejected: <strong><?= $rejected_equipment; ?></strong></div>
            </div>
        </div>
        <div class="report-section">
            ...
            <div class="status-list">
                ...
                <div>⏳ Pending: <strong><?= $pending_bookings; ?></strong></div>
