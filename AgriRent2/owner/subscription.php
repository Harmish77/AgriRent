...
if ($_POST) {
    if (isset($_POST['subscribe_plan'])) {
        ...
        try {
            ...
            $active_check->bind_param("i", $owner_id);
            ...
            if ($active_result->num_rows > 0) {
                ...
                $pending_check->bind_param("i", $owner_id);
                ...
                if ($pending_result->num_rows > 0) {
                    ...
                    $plan_stmt = $conn->prepare("SELECT * FROM subscription_plans WHERE plan_id = ? AND user_type = 'O'");
                    ...
                    if ($plan_result->num_rows > 0) {
                        ...
                        $subscription_stmt->bind_param("ii", $owner_id, $plan_id);
                        ...
                        if ($subscription_stmt->execute()) {
                            ...
                            if ($payment_stmt->execute()) {
                                ...
                                $_SESSION['pending_payment'] = [
                                    ...
                                    'plan_id' => $plan_id,
                                    'plan_name' => $plan['Plan_name'], // Correct field name
                                    'amount' => $plan['price'], // Correct field name
...
");
$pending_payment_stmt->bind_param("i", $owner_id);
...
<div class="main-content">
    ...
    <?php if ($pending_payment): ?>
        ...
        <div style="background: linear-gradient(135deg, #e3f2fd, #bbdefb); color: #0d47a1; padding: 18px; border-radius: 12px; margin-bottom: 20px; text-align: center; border-left: 4px solid #2196f3;">
            ...
            <div style="margin-top: 15px;">
                <a href="../view_payment_details.php?payment_id=<?= $pending_payment['Payment_id'] ?>" style="background: #2196f3; color: white; padding: 10px 20px; border: none; border-radius: 5px; text-decoration: none; display: inline-block; margin: 0 5px; font-weight: bold;">
                ...
                <tbody>
                    <?php foreach ($payments as $payment): ?>
                        <tr>
                            ...
                            <td>
                                <a href="../view_payment_details.php?payment_id=<?= $payment['Payment_id'] ?>" class="btn btn-sm">
