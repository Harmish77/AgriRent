    ...
    $('#categorySearch').on('keyup', function() {
        ...
        if (visibleRows === 0 && searchTerm !== '') {
            if ($('#noResultsRow').length === 0) {
                $('#categoriesTable').append('<tr id="noResultsRow"><td colspan="4" style="text-align: center; padding: 20px; font-style: italic;">No equipment categories found matching your search</td></tr>');
            }
        } else {
            $('#noResultsRow').remove();
        }
