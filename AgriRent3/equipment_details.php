...
<!-- COMPLAINT FORM - Add this to equipment/product details page -->
<div style="background: white; border: 1px solid #ddd; padding: 10px; border-radius: 8px; width: 50%; margin-top: 30px;">
    <h3 style="color: #234a23; margin-bottom: 15px;">Report Problem</h3>
    ...
    <?php if (!isset($_SESSION['user_id'])): ?>
        <p style="color: #666;">
            <a href="../login.php">Login</a> to submit a complaint
        </p>
    <?php else: ?>
        <form method="POST" style="display: flex; flex-direction: column; gap: 15px;">
            <input type="hidden" name="complaint_type" value="E"> <!-- Change to 'P' for products -->
            <input type="hidden" name="item_id" value="<?= isset($equipment_id) ? $equipment_id : 0 ?>">
            ...
            <button type="submit" name="submit_complaint" 
                    style="background: #234a23; color: white; padding: 12px; border: none; border-radius: 4px; cursor: pointer; font-weight: bold;">
                Submit Complaint
            </button>
        </form>
    <?php endif; ?>
