            ...
            <div style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); margin-bottom: 30px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 25px; margin-bottom: 30px;">
                    ...
                    <div>
                        ...
                        <p style="font-size: 18px; font-weight: 600; color: #333; margin: 0;"><?= number_format($product['Quantity'], 2) ?> </p>
                    </div>
                    <div>
    ...
    <?php else: ?>
        <form method="POST" style="display: flex; flex-direction: column; gap: 15px;">
            ...
            <button type="submit" name="submit_complaint" 
                    style="background: #dc3545; color: white; padding: 12px; border: none; border-radius: 4px; cursor: pointer; font-weight: bold;">
                Submit Complaint
            </button>
        </form>
    <?php endif; ?>
