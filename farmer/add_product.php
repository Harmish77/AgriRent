    ...
    <div class="form-section">
        ...
        <form method="POST" id="productForm" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group">
                ...
                <small>Upload a clear image of your product (JPG, PNG, GIF - Max 5MB). Optional but recommended for better visibility.</small>
            ...
            <div style="display: flex; gap: 20px; align-items: start;">
                ...
                <div class="form-group" style="flex: 1;">
                    ...
                    <select name="unit" id="unit" required>
                        ...
                        <option value="K" <?= (($_POST['unit'] ?? '') === 'KG') ? 'selected' : '' ?>>
                            Kilogram (Kg)
                        </option>
    ...
    if (price > 0 && quantity > 0 && unit) {
        ...
        details.innerHTML = `
            ...
            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                ...
                <strong>${quantity} ${unit === 'KG' ? 'kg' : (unit === 'L' ? 'liters' : 'pieces')}</strong>
            </div>
